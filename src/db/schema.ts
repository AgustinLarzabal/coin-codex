...
export const coinCandidates = pgTable("coin_candidates", {
  ...
  originalDetailUrl: text("original_detail_url").notNull(),
  ...
  issuerRaw: text("issuer_raw").notNull(),
  issuerNormalized: text("issuer_normalized").notNull(),
  denomination: text("denomination").notNull(),
  denominationRaw: text("denomination_raw").notNull(),
  denominationNormalized: text("denomination_normalized").notNull(),
